...
//import com.jess.ui.TwoWayGridView.TwoWayGridView;
 ...
 */
public class ContainerViewAlbumGridView extends AppCompatActivity implements RetornoSincronizador {
        ...
        if (savedInstanceState != null) {
            ...
            if (telaCadastro.equals("configuracao")) {
                ...
                if (configGeral.getCodCampanhaPadrao() == 0) {
                    ...
                    new ListarTodosProdutosTask(ContainerViewAlbumGridView.this).execute();
                } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchView sv = new SearchView(ContainerViewAlbumGridView.this);
            ...
            case R.id.menu_sincronizar:
                ...
                if (usuario != null) {
                    ...
                    if (usuario.getPerfil().getId_perfilUser() == 1) {
                        ...
                        new Sincronizador(ContainerViewAlbumGridView.this, this).execute();
            ...
            case R.id.menu_configurar:
                ...
                if (usuario != null) {
                    ...
                    if (usuario.getPerfil().getId_perfilUser() == 1) {
                        ...
                        startActivityForResult(new Intent(ContainerViewAlbumGridView.this, ContainerConfiguracao.class), 2);
                        aProduto = null;
                    }
                }
            ...
            case R.id.menu_cadastrar_campanha:
                ...
                if (usuario != null) {
                    ...
                    if (usuario.getPerfil().getId_perfilUser() == 1) {
                        ...
                        startActivity(new Intent(ContainerViewAlbumGridView.this, CadastrarCampanha.class));
                    }
                }
            ...
            case R.id.menu_cadastrar_usuario:
                ...
                if (usuario != null) {
                    ...
                    if (usuario.getPerfil().getId_perfilUser() == 1) {
                        ...
                        startActivity(new Intent(ContainerViewAlbumGridView.this, ContainerUsuario.class));
                    }
                }
    ...
    private void preencherConfiguracaoGeral() {
        ...
        aConfGeral = new ConfigGeralDAO(ContainerViewAlbumGridView.this).pesqConfigGeral();
    ...
    private void listarItensCampanha() {
        ...
        CampanhaDAO campanhaDAO = new CampanhaDAO(ContainerViewAlbumGridView.this);
        ...
        adapter = new ViewAlbumGridAdapter(ContainerViewAlbumGridView.this, aProduto, configGeral, y, x);
        // viewPager.setAdapter(adapter);
    ...
    private void listartodosProdutos() {
        ...
        if (aProduto != null && aProduto.size() > 0) {
            ...
            aProduto = new ProdutoDAO(ContainerViewAlbumGridView.this).busca("%%", 2);
            //adapter = new ViewAlbumAdapter(ContainerViewAlbumGridView.this, aProduto, configGeral, y, x);
            adapter = new ViewAlbumGridAdapter(ContainerViewAlbumGridView.this, aProduto, configGeral, y, x);
            // gridView.setAdapter(adapter);
            //viewPager.setAdapter(adapter);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            AndroidUtils.sairActivity(ContainerViewAlbumGridView.this);
        }
    ...
    private class FilterListener implements SearchView.OnQueryTextListener {
        ...
        public boolean onQueryTextSubmit(String textoFinal) {
            ...
            /*Exibe no RecicleView um Adapter com apenas a lista que fez o filtro*/
                ...
                //viewPager.setOffscreenPageLimit(2);
                //   gridView.setAdapter(new ViewAlbumGridAdapter(ContainerViewAlbumGridView.this, list, configGeral, y, x));
                // AndroidUtils.closeVirtualKeyboard(ContainerViewAlbumGridView.this, viewPager);
                //AndroidUtils.closeVirtualKeyboard(ContainerViewAlbumGridView.this, gridView);
                aProduto = null;
